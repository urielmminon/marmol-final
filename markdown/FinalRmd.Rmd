...
En cuanto a la ingeniería de características, se construyeron las siguientes variables a partir de las disponibles originalmente:
...
* Se ajusta un modelo con los mejores hiperparámetros sobre toda la base train utilizando cross validation
